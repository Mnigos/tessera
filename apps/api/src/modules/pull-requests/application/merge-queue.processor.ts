...
import type { MergeBlockingReason, MergeRequirements } from '@repo/contracts'
		...
		return await this.pause(entry, pullRequest, requirements, leaseOwner, [
			kind === 'merge_conflict'
				...
				: {
						...
						actualBaseSha: requirements.evaluatedBaseSha ?? evaluatedBaseSha,
						expectedHeadSha: evaluatedHeadSha,
						actualHeadSha: requirements.evaluatedHeadSha ?? evaluatedHeadSha,
					},
		])
	}
