...
SET "next_sync_at" = coalesce("last_sync_succeeded_at", "last_sync_failed_at", "updated_at", "created_at", now()) + interval '15 minutes'
WHERE "provider" = 'github'
	AND "mirror_mode" = 'github_to_tessera'
	AND "sync_status" IN ('succeeded', 'failed');--> statement-breakpoint
