...
ALTER TABLE "repository_external_sources" ADD CONSTRAINT "repository_external_sources_cutover_actor_user_id_user_id_fk" FOREIGN KEY ("cutover_actor_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;
